...
: "${CLICKHOUSE_TRANSFERS_TABLE:=default.transfers}"
...
if [[ -z "${CLICKHOUSE_TRANSFERS_LOCAL_TABLE:-}" ]]; then
  CLICKHOUSE_TRANSFERS_LOCAL_TABLE="$(derive_local_table "${CLICKHOUSE_TRANSFERS_TABLE}")"
fi
...
export CLICKHOUSE_TRANSFERS_TABLE
...
export CLICKHOUSE_TRANSFERS_LOCAL_TABLE
