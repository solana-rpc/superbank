...
-- Local-only GSFA hot materialized view (single-node deployments).
...
CREATE MATERIALIZED VIEW IF NOT EXISTS default.gsfa_hot
(
...
ALTER TABLE default.gsfa_hot MODIFY QUERY
WITH
    [
        CAST(base58Decode('Memo1UhkJRfHyvLMcVucJwxXeuD728EqVDDwQDxFMNo') AS FixedString(32)),
        CAST(base58Decode('MemoSq4gqABAXKb96qnH8TysNcWxMyWCqXgDLGmfcHr') AS FixedString(32)),
